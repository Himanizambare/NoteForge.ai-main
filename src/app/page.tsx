    ...
    <div className="flex flex-col min-h-screen ">
      <header className="px-4 lg:px-6 h-14 flex  items-center border-b sticky top-0 bg-background z-50">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-xl font-bold">NoteForge.ai</span>
        </Link>
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4">
                    "NoteForge.ai has revolutionized the way I interact with
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    NoteForge.ai has significantly reduced the time I spend
              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mb-4">
                    ...
                    using NoteForge.ai. It's an indispensable tool for our market
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-white/80 md:text-xl">
                  ...
                  way they interact with PDF documents using NoteForge.ai.
                </p>
              </div>
              <div className="w-full max-w-sm space-y-2">
                ...
                <p className="text-xs text-white/60">
                  Try NoteForge.ai free for 14 days. No credit card required.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-blue-200">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          © 2024 NoteForge.ai. All rights reserved.
        </p>
